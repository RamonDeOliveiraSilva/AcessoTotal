...
public class JDOUtils {
	...
	@SuppressWarnings("unchecked")
	public <T> List<T> findByAttribute(Class<T> class1, String attribute,
			String value) {
		// TODO mudar para prepared query
		String query = "select from " + class1.getName() + " where "
				+ attribute + " == \"" + value + "\"";
	...
	@SuppressWarnings("unchecked")
	public <T> List<T> findByAttributes(Class<T> clazz,
	...
	@SuppressWarnings("unchecked")
	public <T> List<T> findByAttribute(Class<T> clazz, String attribute,
			Key value) {
	...
	@SuppressWarnings("unchecked")
	public <T> T findFirstByAttribute(Class<T> clazz, String attribute,
			String value) {
		// TODO mudar pra prepared query
		String query = "select from " + clazz.getName() + " where " + attribute
				+ " == \"" + value + "\"";
		List<T> list = (List<T>) pm.newQuery(query).execute();
